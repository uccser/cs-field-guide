    ...
    return function(subscriber) {
      ...
      subscription = _this.subscribe({
        start: function(subscription) {
          return typeof subscriber.start === "function" ? subscriber.start(subscription) : void 0;
        },
        next: function(value) {
          if (typeof subscriber.next === "function") {
...
Observable.prototype.start = function() {
  ...
  observable = new Observable(function(_subscriber) {
    subscriber = _subscriber;
    return function() {
      return subscriber = null;
    };
  });
  observable.stop = function() {
    if (subscriber != null) {
      if (typeof subscriber.complete === "function") {
        subscriber.complete();
      }
  ...
  return new Observable((function(_this) {
    return function(subscriber) {
      ...
      subscript = _this.subscribe({
        ...
        next: function(value) {
          if (!found.has(keySelector(value))) {
            return typeof subscriber.next === "function" ? subscriber.next(value) : void 0;
          }
        },
        error: function(err) {
...
Observable.prototype.debounce = function(time) {
...
Observable.prototype.throttle = function(period) {
  ...
  return new Observable((function(_this) {
    return function(subscriber) {
      ...
      subscription = _this.subscribe({
        ...
        error: function(err) {
          return typeof subscriber.error === "function" ? subscriber.error(value) : void 0;
        },
        complete: function(value) {
          return typeof subscriber.complete === "function" ? subscriber.complete(value) : void 0;
        }
