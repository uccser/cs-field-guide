(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.FSA = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
"use strict";
var ArrayMap, FSA, FSARunner, toSet, u,
  slice = [].slice;
...
FSA = (function() {
  function FSA(fsa) {
    ...
    /* fsa is an object with fields:
        ...
        States:
            ...
            ...<moreStates>
     */
    var _, label, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, state, symbol, transition;
    this.title = fsa.title;
    this.states = (ref = fsa.States) != null ? ref : {};
    ...
    if (fsa.Alphabet != null) {
      ...
      ref2 = (ref1 = fsa.States) != null ? ref1 : {};
      for (_ in ref2) {
        state = ref2[_];
        for (symbol in (ref3 = state.transitions) != null ? ref3 : {}) {
    ...
    for (label in ref4) {
      state = ref4[label];
      for (symbol in (ref5 = state.transitions) != null ? ref5 : {}) {
        if (!this.alphabet.has(symbol)) {
          throw new TypeError("State " + label + " has transition for " + symbol + " but " + symbol + " not in Alphabet (" + this.alphabet + ")");
        }
      }
    }
    ref6 = this.states;
    for (label in ref6) {
      state = ref6[label];
      ref8 = (ref7 = state.transitions) != null ? ref7 : {};
      for (symbol in ref8) {
        transition = ref8[symbol];
        if (transition.constructor === String) {
          state.transitions[symbol] = [transition];
        }
      }
    }
    this.deterministic = (ref9 = fsa.Deterministic) != null ? ref9 : false;
    ...
    this.alphabetNames = (ref10 = fsa.AlphabetNames) != null ? ref10 : {};
    this.epsilonName = (ref11 = fsa.EpsilonName) != null ? ref11 : 'ε';
  }

  FSA.prototype.isDFA = function() {
     ...
     */
    var i, label, len, ref, ref1, ref2, ref3, ref4, ref5, state, symbol, transition;
    if (this.start.length !== 1) {
      ...
      for (label in ref) {
        state = ref[label];
        ref2 = (ref1 = state.transitions) != null ? ref1 : {};
        for (symbol in ref2) {
          transition = ref2[symbol];
          if (transition.length !== 1) {
            if (transition.length === 0) {
              this.isDFA.reason = "State " + label + " missing transition for symbol " + symbol;
            } else {
              this.isDFA.reason = "State " + label + " has more than one transition for symbol " + symbol;
            }
            return false;
          }
        }
      }
      ref3 = Array.from(this.alphabet);
      for (i = 0, len = ref3.length; i < len; i++) {
        symbol = ref3[i];
        ref4 = this.states;
        for (label in ref4) {
          state = ref4[label];
          if (((ref5 = state.transitions) != null ? ref5 : [])[symbol] == null) {
  ...
  FSA.prototype.nextState = function(states, symbol) {
     ...
     */
    var i, j, k, len, len1, len2, newState, newStates, nextState, ref, ref1, ref2, result, state, transitions;
    if (states == null) {
      result = this.epsilonClosure(this.start);
      if (result.length === 1) {
        return result[0];
      } else {
        return result;
    ...
    for (i = 0, len = states.length; i < len; i++) {
      state = states[i];
      transitions = (ref = this.states[state].transitions) != null ? ref : {};
      if (symbol in transitions) {
        ref1 = transitions[symbol];
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          nextState = ref1[j];
          ref2 = this.epsilonClosure(nextState);
  ...
  FSA.prototype.isFinal = function(states) {
    ...
    for (i = 0, len = states.length; i < len; i++) {
      ...
      if ((ref = this.states[state].final) != null ? ref : false) {
        return true;
      }
    }
    return false;
  ...
  FSA.prototype.epsilonClosure = function(states, found) {
    var i, j, k, len, len1, len2, missingStates, otherState, ref, ref1, state;
    if (found == null) {
      found = null;
    }
    ...
    missingStates = states.filter((function(_this) {
      return function(state) {
        return !(state in _this.states);
      };
    })(this));
    if (missingStates.length !== 0) {
      throw new Error("States " + missingStates + " not in automaton");
    }
    if (found == null) {
      found = new Set(found);
    }
    states = states.filter((function(_this) {
      return function(state) {
        return !found.has(state);
      };
    })(this));
    for (i = 0, len = states.length; i < len; i++) {
      state = states[i];
    ...
    for (j = 0, len1 = states.length; j < len1; j++) {
      state = states[j];
      ref1 = (ref = this.states[state].epsilonTransitions) != null ? ref : [];
...
FSARunner = (function() {
  ...
  FSARunner.prototype._bind = function(type, states, handler) {
  ...
  FSARunner.prototype._unbind = function(type, states, handler) {
  ...
  FSARunner.prototype._unbindAll = function(type, states) {

    /* This removes all handlers from the given set of states */
    return this._stateHandlers[type]["delete"](states);
  };

  FSARunner.prototype._bindEntry = function(states, handler) {
  ...
  FSARunner.prototype._bindPartialEntry = function(states, handler) {
  ...
  FSARunner.prototype._normalizeStates = function(states) {
    ...
    for (j = 0, len1 = states.length; j < len1; j++) {
      state = states[j];
      missingStates = state.filter((function(_this) {
        return function(label) {
          return !(label in _this.fsa.states);
        };
      })(this));
      if (missingStates.length !== 0) {
        throw new Error("States " + missingStates + " can't be bound to as they do not exist on the FSA");
      }
    }
    return states;
  };

  FSARunner.prototype.on = function() {
    var handler, i, states;
    states = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), handler = arguments[i++];

    /* This is just an alias for onEntry */
    return this.onEntry.apply(this, slice.call(states).concat([handler]));
  };

  FSARunner.prototype.onEntry = function() {
    var handler, i, j, len, state, states;
    states = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), handler = arguments[i++];
  ...
  FSARunner.prototype.onExit = function() {
    var handler, i, j, len, state, states;
    states = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), handler = arguments[i++];
  ...
  FSARunner.prototype.onPartial = function() {
    var handler, i, states;
    states = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), handler = arguments[i++];

    /* This is just an alias for onPartialEntry */
    return this.onPartialEntry.apply(this, slice.call(states).concat([handler]));
  };

  FSARunner.prototype.onPartialEntry = function() {
    var handler, i, j, len, state, states;
    states = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), handler = arguments[i++];
  ...
  FSARunner.prototype.onPartialExit = function() {
    var handler, i, j, len, state, states;
    states = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), handler = arguments[i++];
  ...
  FSARunner.prototype.off = function() {
    var handler, i, states;
    states = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), handler = arguments[i++];

    /* This is just an alias for offEntry */
    return this.offEntry.apply(this, slice.call(states).concat([handler]));
  };

  FSARunner.prototype.offEntry = function() {
    var handler, i, j, len, state, states;
    states = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), handler = arguments[i++];
  ...
  FSARunner.prototype.offPartialEntry = function() {
    var handler, i, j, len, state, states;
    states = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), handler = arguments[i++];
    states = this._normalizeStates(states);
    for (j = 0, len = states.length; j < len; j++) {
  ...
  FSARunner.prototype.offExit = function() {
    var handler, i, j, len, state, states;
    states = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), handler = arguments[i++];
    states = this._normalizeStates(states);
    for (j = 0, len = states.length; j < len; j++) {
  ...
  FSARunner.prototype.offPartialExit = function() {
    var handler, i, j, len, state, states;
    states = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), handler = arguments[i++];
    states = this._normalizeStates(states);
    for (j = 0, len = states.length; j < len; j++) {
  ...
  FSARunner.prototype.onChange = function(handler) {
  ...
  FSARunner.prototype.offChange = function(handler) {
  ...
  FSARunner.prototype.onComplete = function(handler) {
  ...
  FSARunner.prototype.offComplete = function(handler) {
    this._completeHandlers["delete"](handler);
    return this;
  };

  FSARunner.prototype.callHandler = function(handler, stateInfo) {
    if (stateInfo == null) {
      stateInfo = null;
    }
  ...
  FSARunner.prototype.trigger = function() {

    /* This is simply an alias for triggerEntry */
    return this.triggerEntry();
  };

  FSARunner.prototype.triggerEntry = function() {
     ...
     */
    var ref;
    ((ref = this._stateHandlers.entry.get(this.currentState)) != null ? ref : new Set()).forEach((function(_this) {
      return function(handler) {
        return _this.callHandler(handler);
      };
    })(this));
    this._stateHandlers.partialEntry.forEach((function(_this) {
      return function(handlers, partialStates) {
        if (u.difference(partialStates, _this.currentState).length === 0) {
  ...
  FSARunner.prototype.triggerExit = function(states) {
    ...
    ((ref = this._stateHandlers.exit.get(this.previousState)) != null ? ref : new Set()).forEach((function(_this) {
      return function(handler) {
        return _this.callHandler(handler);
      };
    })(this));
    this._stateHandlers.partialExit.forEach((function(_this) {
      return function(handlers, partialStates) {
        if (u.difference(partialStates, _this.previousState).length === 0) {
          return handlers.forEach(function(handler) {
            return _this.callHandler(handler);
          });
        }
  ...
  FSARunner.prototype.triggerStateChange = function() {
    ...
    return this._globalHandlers.forEach((function(_this) {
      return function(handler) {
        return _this.callHandler(handler);
      };
    })(this));
  ...
  FSARunner.prototype.state = function() {
    ...
    if (this.currentState.length === 1) {
      ...
      return this.currentState.slice(0);
    }
  };

  FSARunner.prototype.isFinal = function() {

    /* Returns true if we're currently in a final state */
    return this.fsa.isFinal(this.currentState);
  };

  FSARunner.prototype.goto = function(states) {

    /* Forces a change to state given regardless of current state */
    this.previousState = this.currentState;
    this.currentState = states.constructor === String ? [states] : states;
    this.previousSymbol = null;
    this.triggerStateChange();
    return this;
  };

  FSARunner.prototype.next = function(symbol) {
  ...
  FSARunner.prototype.feed = function(symbols, done) {
    var i, len, symbol;
    if (done == null) {
      done = false;
    }
  ...
  FSARunner.prototype.complete = function() {
     ...
     */
    return this._completeHandlers.forEach((function(_this) {
      return function(handler) {
        return _this.callHandler(handler);
      };
    })(this));
...
},{"es6-array-map":2,"es6-shim":3,"underscore":5}],2:[function(require,module,exports){
