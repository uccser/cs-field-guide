...
"use strict";
var $button, $text, $utf16, $utf32, $utf8, bitLength, textEncoding;
...
bitLength = function(text, encoding) {
  var encoder;
  if (encoding == null) {
    encoding = 'utf-8';
  }
...
$button.on('click', function() {
  ...
  return $utf32.html(Array.from($text.val()).length * 32 + " bits");
});


},{"es6-shim":2,"text-encoding":4}],2:[function(require,module,exports){
...
},{"./lib/encoding.js":6}],5:[function(require,module,exports){
(function(global) {
  'use strict';
