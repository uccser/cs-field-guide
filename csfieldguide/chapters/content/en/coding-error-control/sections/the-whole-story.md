...
For human readable numbers such as barcodes, bank numbers, tax numbers, social security numbers and so on, [checksums](https://en.wikipedia.org/wiki/Checksum) are very common, and the [Luhn algorithm](https://en.wikipedia.org/wiki/Luhn_algorithm) is one of the more widely used.
