...
Instagram, Facebook, Twitter, SnapChat, TradeMe, Spotify, Uber, Netflix, Messenger, etc. all care about how, when, why, and for how long you use their services.
...
When data is stored in the "cloud" it simply means it is stored somewhere other than you're own computer - it is stored in a remote database that you can access over a network (typically the internet).
...
An important thing to realise about cloud computing is that this data isn't just floating around in one big... well, cloud!
...
For example, one shows a lightbulb, one shows a washing machine, and one shows a smart watch."}
...
- Many different types of sensors are used for health care monitoring.
...
Companies such as Google, Amazon, Microsoft, and even Catalyst here in New Zealand offer services where other organisations can rent space in their data centres instead of having to build their own (an expensive endeavour).
