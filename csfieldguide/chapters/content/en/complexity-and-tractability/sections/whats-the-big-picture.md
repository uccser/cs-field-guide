...
For example, if you needed to visit Queenstown, Christchurch, Auckland, and Wellington while minimising airfares and you knew the price of an airfare between each pair of those 4 cities, you could work out what the cheapest way of touring all of them is.
...
The following interactive has a program that solves the Travelling Salesperson problem for however many cities you want to select by trying out all possible routes, and recording the best so far.
