...
The most important thing to remember about algorithms is that there can be many different algorithms that solve the same problem, but some are much better than others!
