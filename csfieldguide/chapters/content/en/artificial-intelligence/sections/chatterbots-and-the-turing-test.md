# Chatterbots - will be subsumed by new sections
...
You may come across chatbots online for serious uses (such as giving help on a booking website).
...
We saw above that Eliza is a chatbot who works with a restricted domain (trying to take the role of a therapist), and tried to sound intelligent by giving very general responses.
...
Try having a conversation with another chatbot &ndash; **A.L.I.C.E**.
...
We saw examples in the previous sections of two chatbots that have rules that help them determine suitable things to say.
One of those chatbots only works in a restricted domain, taking the role of a therapist.
...
Both these chatbots had their *rules* of what to say determined by programmers *at the time of programming*, and these rules will never be changed unless a programmer decides to change them.
This is the most basic form of artificial intelligence.

There are other chatbots that are able to *learn* their rules from the humans they have conversations with.
By looking at how a human responds to various dialogues, the chatbot attempts to learn how it should respond in various situations.
...
Please note that the following exercise involves interacting with one of these chatbots.
Because the chatbot has learnt from humans, it will quite possibly have been taught to say things that you may find highly offensive.
While we have tried to choose chatbots that mostly say things that aren’t going to offend, it is impossible to guarantee this, so use your discretion with them; you can skip this section and still cover the main concepts of this chapter.
Because Eliza and Alice don’t learn from humans, they won’t say offensive things unless you do first!

And again, don’t tell the chatbots your personal details (such as your full name, date of birth, address, or any other personal information).
Just make stuff up where necessary.
A chatbot that learns from people quite possibly *will* pass on what you say to other people in an attempt to sound intelligent to *them*!
...
Try looking at the [list on wikipedia](https://en.wikipedia.org/wiki/List_of_chatbots), or doing a Google search for chatbots.
Each chatbot on this list has its own Wikipedia page.
You should be able to find the chatbots by either an internet search, or looking at the references of the Wikipedia pages.
...
In the above sections you met some chatbots, and (hopefully!) have drawn the conclusion that they aren’t entirely convincing in terms of sounding like a human (although some are better than others!).
But maybe soon, there will be new chatbots that don’t have the same limitations.
Should we consider them to be intelligent?
How could we tell?
Is there a formal way we can determine whether or not a chatbot is at the level of human intelligence?

A very famous computer scientist, Alan Turing, answered this question back in 1950, before the first chatbots even existed!
...
For example, most chatbots communicate in a text form rather than verbal.
...
Choose a chatbot from the list on Wikipedia (see the above chatbots section), or possibly use Alice or Cleverbot (Eliza isn’t recommended for this).
...
Do *not* choose your best friend in the class, because you will know their responses to questions too well, so will be able to identify them from the chatbot based on their personality rather than the quality of the chatbot.

In addition to the chatbot and your classmate to act as the human, you will need access to: a room with a computer with internet (this could just be the computer classroom); another room outside it (a hallway would be fine); pieces of paper; 2 pens; and a coin or die.

The chatbot should be loaded on the computer to be used, and your classmate should be in the same room with the computer.
...
If your classmate is currently supposed to be having the conversation (rather than the chatbot), they will write the reply based on what they would say.

If the chatbot is currently supposed to be having the conversation, your classmate should type what you said into the chatbot and then write its reply on the piece of paper.
Before submitting the line to the chatbot, they should double check it was entered correctly.

A problem is that it will take longer for the conversation between you and the chatbot than between you and the classmate, because of the need for your classmate to type what you say to the chatbot.
...
You can ask whatever you like, although keep in mind that you should be assuming you don’t know your classmate already, so don’t refer to common knowledge about previous things that happened such as in class or in the weekend in what you ask your classmate or the chatbot.
This would be unfair to the chatbot since it can’t possibly know about those things.
Remember you’re evaluating the chatbot on its ability to display human intelligence, not on what it doesn’t know about.
...
Once both conversations are complete, you as the interrogator have to analyse the conversations and say which was your classmate, and which was the chatbot.
...
- How were you able to tell which was the chatbot and which was your classmate?
