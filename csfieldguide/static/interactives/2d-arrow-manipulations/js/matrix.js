module.exports = {
    ...
    matrixTab: function(matrixInputBox) {
    ...
    */
    matrixOperations: function(test, interfaceSettings) {
    ...
    */
    scale: function(id, productMatrix, interfaceSettings) {
    ...
    */
    translate: function(id, productMatrix, interfaceSettings) {
