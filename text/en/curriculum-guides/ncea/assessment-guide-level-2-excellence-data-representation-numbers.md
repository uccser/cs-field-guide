...
1. A **positive** number **between 65 and 120**<br>
2. A **negative** number **between -10 and -64**<br>
...
Number 1: **positive number** in binary with a **simple sign bit**.<br>
Number 2: **additional positive number** in binary with a **simple sign bit**.<br>
Number 3: **positive number** in binary, using Two's Complement (remember that this is just a plain binary number).<br>
Number 4: **negative number** in binary, using Two's Complement.<br>
Number 5: **additional positive number** in binary, using Two's Complement (remember that this is just a plain binary number).<br>
{text-box end}
