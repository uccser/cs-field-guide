...
{panel type="teacher-note" summary="Curriculum Guides for Software Engineering"}
TODO
{panel end}
...
The rollover text of the above image (you will need to actually view it on [xkcd's website](http://xkcd.com/1425/)) is worth reading too. Image recognition is a problem which initially seemed straightforward, probably because humans find it easy. Interestingly, there are many problems which computers find easy, but humans find challenging, such as multiplying large numbers. On the contrary, there are many other problems which computers find hard, yet humans find easy, such as recognizing that the thing in a photo is, for example, a cat.
{panel end}
