...
class GlossaryItem:
    ...
    def to_html(self):
        if self.defined:
            ...
            return template.format(term=self.displayed_term, term_id=self.term_id, back_permalink=self.back_permalink, definition=self.definition, other_links=backwards_links, heading_level=heading_level, extra_classes=extra_classes)
        else:
